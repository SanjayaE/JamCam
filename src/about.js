      ...
      <div id="about">
        ...
        <div class="text_block">
          ...
          <p>
            ...
            provided by Tone.Js, a framework for creating interactive music in the
            browser. All you have to do is your put wrists in the right area, and enjoy
            the magic.
          </p>
        </div>
        <h3> Who made this?</h3>
        <div class="info_card">
          ...
          <div class="card-text">
            ...
            <p>Julia likes to use code and technology to make creative projects.
